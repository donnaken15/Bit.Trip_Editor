...
draw_text(view_wview[0],view_hview[0],"KEY:"+string(keyboard_key)+"
...
draw_text(view_wview[0],view_hview[0],"FPS:"+string(fps)+"/"+string(room_speed)+"
...
")
draw_set_color(c_black)
draw_text(view_wview[0],view_hview[0],"OBJS:"+string(instance_count)+"

MOUSE:"+string(mouse_button)+"
RES:"+string(view_wview[0])+"x"+string(view_hview[0])+"
PTR:"+string(mouse_x)+","+string(mouse_y)+"
VEL:"+string(mouse_x-mouse_x_last)+","+string(mouse_y-mouse_y_last)+"
ACTIVE:"+string(active)+"
HANDLE:"+string(window_handle())+"
BUILDTIME:"+string(builddate)+"
