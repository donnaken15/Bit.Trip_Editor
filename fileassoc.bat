...
reg add HKCR\BitTripEditor.Beat\DefaultIcon /ve /d "%~dp0icons.dll,0"
reg add HKCR\BitTripEditor.Core\DefaultIcon /ve /d "%~dp0icons.dll,1"
reg add HKCR\BitTripEditor.Void\DefaultIcon /ve /d "%~dp0icons.dll,2"
reg add HKCR\BitTripEditor.Runner\DefaultIcon /ve /d "%~dp0icons.dll,3"
reg add HKCR\BitTripEditor.Fate\DefaultIcon /ve /d "%~dp0icons.dll,4"
reg add HKCR\BitTripEditor.Flux\DefaultIcon /ve /d "%~dp0icons.dll,5"
